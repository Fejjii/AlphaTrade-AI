...
_MODEL_KIND: dict[str, PersistenceKind] = {
    ...
    "WatcherPolicyVersionRow": PersistenceKind.WATCHER,
    "WatcherScanLineageRow": PersistenceKind.WATCHER,
    "WatcherScheduledScanRow": PersistenceKind.WATCHER,
    "WatcherScanAttemptRow": PersistenceKind.WATCHER,
    "WatcherSourceFetchAttemptRow": PersistenceKind.WATCHER,
    "WatcherSubscriptionEvalAttemptRow": PersistenceKind.WATCHER,
    "WatcherWorkerLeaseRow": PersistenceKind.WATCHER,
    "WatcherHeartbeatRow": PersistenceKind.WATCHER,
    "WatcherHealthSnapshotRow": PersistenceKind.WATCHER,
    "WatcherObservabilityEventRow": PersistenceKind.WATCHER,
    "TelegramEnrollmentChallengeRow": PersistenceKind.NOTIFICATION,
    "TelegramBindingRow": PersistenceKind.NOTIFICATION,
    "TelegramActionNonceRow": PersistenceKind.NOTIFICATION,
    "TelegramActionReceiptRow": PersistenceKind.NOTIFICATION,
    "TelegramAuthorizationIntentRow": PersistenceKind.NOTIFICATION,
    "TelegramOutboxRow": PersistenceKind.NOTIFICATION,
    "TelegramProtocolAuditEventRow": PersistenceKind.NOTIFICATION,
    ...
    "CanonicalTradePlanRootRow": PersistenceKind.TRADE_PLAN,
    "CanonicalTradePlanLineageRow": PersistenceKind.TRADE_PLAN,
    "CanonicalTradePlanIdempotencyKeyRow": PersistenceKind.TRADE_PLAN,
    "CanonicalCandidateRow": PersistenceKind.CANDIDATE,
    "CanonicalCandidateCreationKeyRow": PersistenceKind.CANDIDATE,
    "CanonicalCandidateTransitionRow": PersistenceKind.CANDIDATE,
    "CanonicalCandidateTransitionKeyRow": PersistenceKind.CANDIDATE,
    "ActionEligibilityEvaluationRow": PersistenceKind.CANDIDATE,
    "ActionEligibilityIdentityBindingRow": PersistenceKind.CANDIDATE,
