...
- `core/config.py`: trading-mode validators (`execution_mode=trade` requires explicit enable).
  `telegram_interaction_enabled` defaults false (AT-043/AT-073; inbound Telegram
...
- `telegram_paper_agent/` (AT-073): paper-only Watcher/Candidate/journal notifications and
